...
\marked{We have added the memory cost in experiment Exp-3. Indeed, the memory cost of (PRank, FRank, SARank) is (12.65GB, 16.42GB, 49.42GB) while set the $Y_s=2015$ on MAG, respectively, and the memory cost of HRank is 61.37GB while set the $Y_s=2014$ on MAG. }
