...
Yes, we have gone over the paper, and tried our test to improve its presentation.
%Thanks for the suggestion!
...
We have reported the memory costs with a new set of tests in the experimental study (Exp-4, page 10). Thanks for the suggestion!
