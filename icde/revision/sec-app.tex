...
\markedb{Figure~\ref{fig-example-graph} shows a real-life example of the heterogeneous academic graph, which is drawn based on the following four articles as well as their citation relationships:}
...
\markedb{Figure~\ref{fig-example-ranking} illustrates an example of the importance assembling procedure. 
