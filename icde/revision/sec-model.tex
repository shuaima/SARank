...
\vspace{-1ex}
\caption{\small Citation statistics of scholarly articles that reports the (logscale) percentage of the number of citations of each year \wrt\ the total number of citations on \aan, \aminer and \magdata, respectively.}
\label{fig-reference}
\vspace{-3ex}
\end{figure}
