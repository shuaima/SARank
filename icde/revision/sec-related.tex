...
Differently, our Time-Weighted PageRank \markedb{is inspired by an analysis of impacts of articles} and discriminately propagates scores in terms of statistics of citations.
...
%
\markedb{In this work, we study dynamic scholarly article ranking in the general case and develop our incremental algorithm based on the citation characteristics, which has never been exploited before.}
