...
\markedb{Note that with \fcita the selected $(\alpha, \beta)$ for \ensemblerank are quite different from the ones with \recom.}
...
\end{center}
\vspace{-1.5ex}
\caption{\small Impacts of TWPageRank on accuracy: varying importance weighting
factor $\lambda$}
\label{exp-drank}
\vspace{-2ex}
\end{figure*}
