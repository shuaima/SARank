...
plot "MAG_lambda.tab" using ($1):($3) title 'SARank(PFCtn)'  with linespoints linetype 1 pointtype 2 lc 7 lw 3,\
"MAG_lambda.tab" using ($1):($2) title 'SARank(Recom)' with linespoints linetype 0 pointtype 6 lc 7 lw 3 
