...
We explain the idea and rational of data approximation,  and show efficiency can be obtained even without sacrificing for effectiveness in practice by its embodiment for shortest paths/distances and link prediction.
