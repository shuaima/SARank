...
We systematically introduce approximate computation (\ie query approximation and data approximation) for efficiency and effectiveness big data analytics in practice.
