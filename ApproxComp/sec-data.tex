...
We show experimentally that about $1/3$  nodes of social networks and road networks  are captured by by proxies, leaving $2/3$ in the reduced graphs.
...
\stitle{(2) Ensemble Enabled Link Prediction~\cite{DuanMAMH17}}
