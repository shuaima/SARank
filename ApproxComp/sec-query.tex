...
\begin{figure}[tb!]
  \vspace{-1ex}
  \begin{center}
  \includegraphics[scale=0.4]{./queryApprox.png}
  \end{center}
  \vspace{-4ex}
...
The compression ratios of lossless methods are poor, and querying on the compressed data is time consuming due to the reconstruction of the original data \cite{Nibali:Trajic}. Hence, lossy techniques, which  provide approximate solutions with good compression ratios and bounded errors, is the mainstream.
