...
\stitle{(3) One-Pass Trajectory Compression~\cite{LinMZWH17}}.  Trajectory compression (also known as trajectory simplification) is to compress data points in a trajectory to a set of continuous line segments, and is commonly used  in practice.
